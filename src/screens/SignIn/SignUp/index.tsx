...
export function SignUp() {
  return (
    <div className="w-screen h-screen bg-[#121214] flex flex-col items-center justify-center text-gray-100">
      <HeaderFormAuth message="Faça o registro e comece a usar !" />
      ...
      <a href="" className="text-gray-400 underline text-gray-200 text-sm mt-4">Ja Possui Conta? Faça Login</a>
    </div>
  );
}
